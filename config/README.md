...
├── respiratory-triage-scenarios/      ← respiratory triage checklist payloads
│   └── respiratory-triage.scenario.json
...
└── respiratory-triage-data.loader.ts ← respiratory triage: getRespiratoryTriageData()
```
